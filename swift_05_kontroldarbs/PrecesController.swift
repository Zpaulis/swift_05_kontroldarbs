...
class PrecesController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    // MARK: - Outltes
    @IBOutlet weak var titlePavNumber: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if let virsraksts = pav?.pavNumber {
            self.titlePavNumber.text = "Pav. Nr. " + virsraksts
        } else {
            self.titlePavNumber.text = "Pavadzīme nav atrasta"
        }
    }
